  ...
  return (
    <div className="signup">
      ...
      <form className="signup__form">
        ...
        <input type="text" id="nom" className="signup__form--input" required />
        ...
        <input
          ...
          required
        />
        <label htmlFor="pseudoInscription" className="signup__form--label">
          Pseudo :
        </label>
        <input
          type="text"
        ...
        <input
          ...
          required
        />
        <label htmlFor="mdpInscription" className="signup__form--label">
          Mot de passe :
        </label>
        <input
          type="password"
          ...
          required
        />
        <label htmlFor="mdp2Inscription" className="signup__form--label">
